...
public class Core implements GraylogServer {
    ...
    private List<Class<? extends MessageFilter>> systemFilters = Lists.newArrayList();
    private List<Class<? extends MessageFilter>> pluginFilters = Lists.newArrayList();
    ...
    public <T extends MessageFilter> void registerSystemFilter(Class<T> klazz) {
        this.systemFilters.add(klazz);
    }

    public <T extends MessageFilter> void registerPluginFilter(Class<T> klazz) {
        this.pluginFilters.add(klazz);
    }
    ...
    public List<Class<? extends MessageFilter>> getSystemFilters() {
